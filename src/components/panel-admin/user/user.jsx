    ...
    <div className={styles.container}>
        ...
        <div>
            ...
            <div className={styles.containerData}>
                <div className={styles.name}><p>{data.displayName}</p></div>
                <div className={styles.email}><p>{data.email}</p></div>
            </div>
            <div className={styles.boton}>
            {userData.active ? (
                <button onClick={() => handlerActive('active', false)}>Desactivar</button>
            ) : (
                <button onClick={() => handlerActive('active', true)}>Activar</button>
            )}
            </div>
        </div>
    </div>
